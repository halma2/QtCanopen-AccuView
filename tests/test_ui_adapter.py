...
class UiAdapterTest(unittest.TestCase):
    ...
    def test_publish_snapshot_emits_statistics_and_graph(self):
        ...
        self.root.statVoltDataChanged.emit.assert_called_once_with([1, 2, 3])
        self.root.statTempDataChanged.emit.assert_called_once_with([10, 20, 30])
        self.root.graphDataChanged.emit.assert_called_once_with([2, 3])
        self.root.groupDataChanged.emit.assert_not_called()
    ...
    def test_publish_snapshot_emits_requested_group(self):
        ...
        self.root.groupDataChanged.emit.assert_called_once_with([1, 2], [20])
    ...
    def test_other_events_are_forwarded(self):
        ...
        self.root.errorOccurred.emit.assert_called_once_with("bus error")
        self.root.portListChanged.emit.assert_called_once_with(["COM1"])
